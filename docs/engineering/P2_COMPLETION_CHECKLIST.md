...
- [!] Synthetic **null_does_not_clear** (E2E-09) **FAIL** — unwrap re-verify: LINK fails with Make `Function 'parseJSON' not found!` (see `20260801T230505Z-form1-config-unwrap-fix-e2e09.md`)
- [x] Cleanup synthetic rows (clients/cases/intakes/config) — zero residue after 20260801T230505Z
- [x] Scenario returned inactive; no leftover schedules
- [x] Evidence artifact under `artifacts/agent-runs/` (`20260801T230505Z-form1-config-unwrap-fix-e2e09.md`)
...
- [x] `brand:guard` pass
- [!] Form 1 E2E green (P2C) — blocked on E2E-09 (`parseJSON` unwrap not valid in Make runtime; need Make-supported remap or object storage)
