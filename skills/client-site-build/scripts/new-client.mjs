...
USAGE
  node skills/client-site-build/scripts/new-client.mjs --init <name> [--force]
  node skills/client-site-build/scripts/new-client.mjs --validate <name> [--verbose] [--profile rush]
  node skills/client-site-build/scripts/new-client.mjs --help
...
EXAMPLES
  node skills/client-site-build/scripts/new-client.mjs --init smoky-mountain
  node skills/client-site-build/scripts/new-client.mjs --validate smoky-mountain
  node skills/client-site-build/scripts/new-client.mjs --validate smoky-mountain --profile rush
`;
