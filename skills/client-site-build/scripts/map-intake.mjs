...
USAGE
  node skills/client-site-build/scripts/map-intake.mjs --sheet <csv> --client <name> [--write-wiring]
  node skills/client-site-build/scripts/map-intake.mjs --brief <txt|json> --client <name> [--write-wiring]
  node skills/client-site-build/scripts/map-intake.mjs --help
