...
for (const [check, evidence] of [
  ...
  ['psi: Perf ≥70 mobile / ≥90 desktop, A11y ≥95, SEO ≥90, CLS <0.1 (TVD-044)', 'npm run psi:mobile -- <staging-url> — PSI, not local Lighthouse; these are the only launch numbers (owner ruling 2026-07-29)'],
